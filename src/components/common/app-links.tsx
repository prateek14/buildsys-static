...
export const AppleLink: React.FunctionComponent = (): JSX.Element => {
    return (
        <a
            className="app-link"
            href="https://apps.apple.com/in/app/buildsys/id1469857877"
            rel="noreferrer"
            target="_blank">
            <AppleSVG></AppleSVG>
        </a>
...
export const GoogleLink: React.FunctionComponent = (): JSX.Element => {
    return (
        <a
            className="app-link"
...
export const AppleSVG: React.FunctionComponent = (): JSX.Element => {
    return (
        <svg id="livetype" xmlns="http://www.w3.org/2000/svg" width="119.66407" height="40" viewBox="0 0 119.66407 40">
            <title>App Store Link</title>
            <g>
                <g>
                    <g>
                        <path
